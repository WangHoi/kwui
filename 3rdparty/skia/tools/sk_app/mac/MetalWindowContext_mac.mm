...
bool MetalWindowContext_mac::onInitializeContext() {
    ...
    fMetalLayer.contentsGravity = kCAGravityBottomLeft;
    ...
    //fMetalLayer.needsDisplayOnBoundsChange = TRUE;
    //fMetalLayer.presentsWithTransaction = TRUE;
    //fMetalLayer.allowsNextDrawableTimeout = FALSE;
