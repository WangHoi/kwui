...
HRESULT FlowLayout::SetTextFormat(ComPtr<IDWriteTextFormat> textFormat)
{
...
HRESULT FlowLayout::SetNumberSubstitution(ComPtr<IDWriteNumberSubstitution> numberSubstitution)
{
...
HRESULT FlowLayout::AnalyzeText(
...
HRESULT FlowLayout::ShapeGlyphRuns(IDWriteTextAnalyzer* textAnalyzer)
{
...
HRESULT FlowLayout::ShapeGlyphRun(
