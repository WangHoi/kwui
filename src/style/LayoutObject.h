...
private:
    ...
    static void arrangeBfcBottom(LayoutObject* o,
                                 BlockFormatContext& bfc,
                                 BlockBox& box);
    static void prepare(LayoutObject* o, InlineFormatContext& ifc, float viewport_width,
                        absl::optional<float> viewport_height);
    static void arrange(LayoutObject* o, InlineFormatContext& ifc, float viewport_width,
                        absl::optional<float> viewport_height);
    static void translate(LayoutObject* o, scene2d::PointF offset);
    static void arrangeInlineBlock(LayoutObject* o, InlineFormatContext& ifc, float viewport_width,
                                   absl::optional<float> viewport_height);
    ...
    static void paintBox(graph2d::PaintContextInterface* painter,
                         const scene2d::RectF& padding_rect,
                         const EdgeOffsetF& border_width,
