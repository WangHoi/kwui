...
static void applyStackBlurBW(JuceImage& img, unsigned int radius)
{
...
static void applyStackBlurRGB(JuceImage& img, unsigned int radius)
{
    const unsigned int w = (unsigned int)img.getWidth();
    const unsigned int h = (unsigned int)img.getHeight();
...
static void applyStackBlurARGB(JuceImage& img, unsigned int radius)
{
    const unsigned int w = (unsigned int)img.getWidth();
    const unsigned int h = (unsigned int)img.getHeight();
...
{
    if (img.getFormat() == JuceImage::ARGB) applyStackBlurARGB(img, (unsigned int)radius);
    if (img.getFormat() == JuceImage::RGB) applyStackBlurRGB(img, (unsigned int)radius);
    if (img.getFormat() == JuceImage::SingleChannel) applyStackBlurBW(img, (unsigned int)radius);
}

JuceImage JuceImage::fromSingleChannel(int w, int h, void* data, int stride)
{
    JuceImage img;
    img.width = w;
    img.height = h;
